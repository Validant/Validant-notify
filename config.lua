...
Config.Inline = false -- if inline is tagged is the Notify inline. if its empty is it not inline.
Config.Round = true --if round is tagged is the Notify round. if its empty is it not round.
Config.Debug = false
Config.ShownTime = 5000 -- This is 5 Sec to display the Notification.